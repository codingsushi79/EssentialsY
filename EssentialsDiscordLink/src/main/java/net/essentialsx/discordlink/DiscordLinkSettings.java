...
public class DiscordLinkSettings implements IConf {
    private final DiscordLinkBridge plugin;
    ...
    public DiscordLinkSettings(DiscordLinkBridge plugin) {
        this.plugin = plugin;
        this.config = new EssentialsConfiguration(new File(plugin.getDataFolder(), "discord-link.yml"), "/discord-link.yml", DiscordLinkBridge.class);
        reloadConfig();
    }
