...
/**
 * Manages EssentialsY's teleport functionality for a player.
 * Use this if you want to access EssentialsY's async/safe teleport functionality and teleport warmups and cooldowns.
 */
