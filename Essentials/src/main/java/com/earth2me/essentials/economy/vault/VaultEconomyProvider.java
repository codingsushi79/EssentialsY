 ...
 * Provides access to the EssentialsY economy for plugins that use the Vault API.
 * <p>
 * Developer note: for accessing Essentials/Vault economy functions from EssentialsY code, see
...
public class VaultEconomyProvider implements Economy {
    ...
    public EconomyResponse createBank(String name, String player) {
        return new EconomyResponse(0, 0, EconomyResponse.ResponseType.NOT_IMPLEMENTED, "EssentialsY does not support bank accounts!");
    }
