...
public class DiscordSettings implements IConf {
    ...
    public DiscordSettings(DiscordBridge plugin) {
        this.plugin = plugin;
        this.config = new EssentialsConfiguration(new File(plugin.getDataFolder(), "discord.yml"), "/discord.yml", DiscordBridge.class);
        reloadConfig();
    }
