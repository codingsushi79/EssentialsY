...
public class ConsoleInjector extends AbstractAppender {
    private final static java.util.logging.Logger logger = DiscordBridge.getWrappedLogger();
    ...
    public ConsoleInjector(JDADiscordService jda) {
        ...
        taskId = Bukkit.getScheduler().runTaskTimerAsynchronously(jda.getPlugin().getEss(), () -> {
